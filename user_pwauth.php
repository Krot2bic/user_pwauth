...
class USER_PWAUTH extends \OC_User_Backend implements \OCP\UserInterface {
	...
	public function __construct() {
		$this->pwauth_bin_path = \OCP\Config::getAppValue('user_pwauth', 'pwauth_path', OC_USER_BACKEND_PWAUTH_PATH);
		$list = explode(';', \OCP\Config::getAppValue('user_pwauth', 'uid_list', OC_USER_BACKEND_PWAUTH_UID_LIST));
		$r = array();
